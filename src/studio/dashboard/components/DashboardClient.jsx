      ...
      <div className="flex items-center justify-between mb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="bg-accent text-surface px-6 py-2.5 rounded-full text-[14px] font-semibold hover:bg-accent/90 active:scale-[0.98] transition-all flex items-center gap-2"
          >
