    ...
    <div className={`flex flex-col items-center justify-center gap-3 ${className}`}>
      <style>{`
        .custom-loader-wrapper {
          --main-color: #2C4035; /* This matches your theme's 'accent' color */
          z-index: 999;
          display: flex;
        ...
        .custom-loader-wrapper svg {
          width: ${pixelSize}px;
          height: ${pixelSize}px;
        }

        .custom-loader-wrapper svg path:first-child {
          will-change: d;
          fill: var(--main-color);
          animation: customMorph 2s ease-in-out infinite;
        }

        .custom-loader-wrapper svg path:not(:first-child) {
          fill: none;
          stroke: var(--main-color);
          stroke-width: 0;
        }

        .custom-loader-wrapper svg path:nth-child(2) {
          animation: customWave 2s linear infinite;
          animation-delay: 1.7s;
        }

        .custom-loader-wrapper svg path:nth-child(3) {
          animation: customWave 2s linear infinite;
          animation-delay: 0.3s;
        }

        .custom-loader-wrapper svg path:nth-child(4) {
          animation: customWave 2s linear infinite;
          animation-delay: 1s;
        }
      ...
      {text && (
        <span className="text-[13px] font-semibold text-muted tracking-wide mt-2">
          {text}
        </span>
      )}
    </div>
